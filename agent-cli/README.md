...
powered by your **local Claude Code, Codex, Grok Build, Cursor Agent, or OpenCode CLI**
...
`cursor-agent` (Cursor), or `opencode` on your `PATH`. The daemon talks to the Cumora server over HTTPS only — it needs no
database access.
